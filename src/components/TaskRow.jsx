...
export const TaskRow = ({task,tags,depth=0,onEdit,onDelete,onToggle,onAddChild,onDuplicate,onMemoToggle,isTouch=false,memoOpen=false,onMemoOpen}) => {
  ...
  return (
    ...
    <div
      ...
      <div className="swipe-actions" style={{position:"absolute",right:0,top:0,height:"auto",display:"flex",alignItems:"center",gap:2,paddingRight:6,paddingTop:5,paddingBottom:5,background:C.bgSub,zIndex:0}}>
